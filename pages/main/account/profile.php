      ...
      <div class="card bg-light mt-5">
        <article class="card-body mx-auto" style="width: 400px;">
          ...
          <form action="" method="POST" >
            ...
            <p class="text-center">
              <a class="btn btn-outline-primary" href="index1.php?navigate=changePassword">Đổi mật khẩu</a>
            </p>
            <p class="text-center">
              <a class="btn btn-outline-primary" href="index1.php?navigate=changeProfile">Sửa thông tin</a> </p>
            </a>
          </form>
        </article>
      </div>

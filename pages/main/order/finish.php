...
?>
  <div class="container min-height-100">
    <div class="text-center mt-60">
      <p>Cảm ơn bạn đã đặt hàng, đơn hàng của bạn đang được xét duyệt, vui lòng chú ý điện thoại, chúng tôi sẽ liên hệ với bạn để xác nhận.</p>
      <a class="btn btn-info" href="index1.php?navigate=orderHistory">Xem lịch sử đơn hàng</a>
    </div>
  </div>
  ...
  <div class="col-md-12 mt-3">
    ...
    <thead>
      ...
      ?>
          ...
          <td>
          <a href="index1.php?navigate=order_detail&id=<?php echo $row_getOrder['ID_DonHang']; ?>">Xem</a>|<a href="admin/modules/manage_orders/indonhang.php?id=<?php echo $row_getOrder['ID_DonHang']; ?>" target="_blank">In hóa đơn</a>
          </td>
    </tbody>
    <?php
        }
